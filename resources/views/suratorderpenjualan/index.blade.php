        ...
        <form>
            <div class="section">
                ...
                <div class="row">
                    ...
                    <div class="col">
                        <div class="form-group">
                            <label for="orderId">ID Surat Order (SO):</label>
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="customerName" placeholder="Masukkan nama konsumen">
                </div>

                <div class="form-group">
                    <label for="selectedItems">Barang yang terpilih:</label>
                    <input type="text" id="selectedItems" placeholder="Pilih barang">
                </div>
                ...
                <div class="row">
                    <div class="col">
                        <div class="form-group">
                            ...
                            <select id="dueDate">
                                <option>Pilih jatuh tempo yang sudah ada sebelumnya.</option>
                            </select>
                        </div>
                    </div>
                    <div class="col">
                        <div class="form-group">
                            <label>Atau Buat termin baru:</label>
                            <input type="text" placeholder="Masukkan termin baru">
                        </div>
                    </div>
                </div>
