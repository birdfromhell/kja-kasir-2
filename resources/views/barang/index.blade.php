                                ...
                                <table class="table">
                                    <thead class="thead-light">
                                        <tr style="background-color: #d3d3d3; color: #000000;">
                                            ...
                                            <th style="background-color: #d3d3d3; color: #000000;">Nomor Barang</th>
                                            <th style="background-color: #d3d3d3; color: #000000;">Nama Barang</th>
                                            <th style="background-color: #d3d3d3; color: #000000;">Satuan</th>
                                            <th style="background-color: #d3d3d3; color: #000000;">Kategori</th>
                                            <th style="background-color: #d3d3d3; color: #000000;">Kelompok Barang</th>
                                            <th style="background-color: #d3d3d3; color: #000000;">Sistem</th>    
                                            <th style="background-color: #d3d3d3; color: #000000;">Phisik</th>
                                            <th style="background-color: #d3d3d3; color: #000000;">Selisih</th>                                   
