                ...
                <div class="nk-block-head nk-block-head-sm">     
                    <div class="nk-block-between">
                        <div class="nk-block-head-content">
                            <h3 class="nk-block-title page-title">Cash Opnem</h3>
                        </div>
                        <div class="nk-block-head-content">
                                ...
                                <table class="table">
                                    <thead class="thead-light">
                                        <tr style="background-color: #d3d3d3; color: #000000;">
                                            ...
                                            <th style="background-color: #d3d3d3; color: #000000;">Pecahan</th>
                                            <th style="background-color: #d3d3d3; color: #000000;">Kertas</th>
                                            <th style="background-color: #d3d3d3; color: #000000;">Logam</th>
                                            <th style="background-color: #d3d3d3; color: #000000;">Jumlah</th>
                                            <th style="background-color: #d3d3d3; color: #000000;">Total</th>                              
                                            ...
                                            <th style="width: 50px; background-color: #d3d3d3; color: #000000;">
                                                <div class="dropdown" style="display: flex; align-items: center;">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right">
                                                        <ul class="link-list-opt no-bdr">
                                                            <li><a href="{{ url('cashopnem/edit') }}"><em class="icon ni ni-edit"></em> Edit</a></li>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <button class="btn btn-primary btn-sm" onclick="window.location.href='{{ url('cashopnem/edit') }}'">
                                                    <em class="icon ni ni-edit"></em>
                                                </button>
                                                <form action="{{ url('/cashopnem/1') }}" method="POST" style="display: inline;">
                                                    @csrf
                                                    @method('DELETE')
