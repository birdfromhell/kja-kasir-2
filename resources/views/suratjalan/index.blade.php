                ...
                <div class="nk-block-head nk-block-head-sm">     
                    <div class="nk-block-between">
                        <div class="nk-block-head-content">
                            <h3 class="nk-block-title page-title">Surat Jalan</h3>
                        </div>
                        <div class="nk-block-head-content">
                                ...
                                <table class="table">
                                    <thead class="thead-light">
                                        <tr style="background-color: #d3d3d3; color: #000000;">
                                            ...
                                            <th style="background-color: #d3d3d3; color: #000000;">ID SO</th>
                                            <th style="background-color: #d3d3d3; color: #000000;">ID SJ</th>
                                            <th style="background-color: #d3d3d3; color: #000000;">Tanggal</th>
                                            <th style="background-color: #d3d3d3; color: #000000;">Detail SO</th>
                                            <th style="background-color: #d3d3d3; color: #000000;">Detail SJ</th>
