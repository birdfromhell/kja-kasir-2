                            ...
                            <li class="nk-menu-heading">
                                ...
                                <li class="nk-menu-item has-sub">
                                    ...
                                    <ul class="nk-menu-sub">
                                        <li class="nk-menu-item">
                                            <a href="{{ url('perusahaan') }}" class="nk-menu-link"><span class="nk-menu-text">Daftar Relasi</span></a>
                                        </li>
                                        <li class="nk-menu-item">
                                        ...
                                        <li class="nk-menu-item">
                                            <a href="{{ url('kelompok')}}" class="nk-menu-link"><span class="nk-menu-text">Daftar Kelompok</span></a>
                                        </li>
                                        <li class="nk-menu-item">
                                ...
                                <li class="nk-menu-item has-sub">
                                    ...
                                    <ul class="nk-menu-sub">
                                        <li class="nk-menu-item">
                                            <a href="{{ url('orderpembelian') }}" class="nk-menu-link"><span class="nk-menu-text">Order Pembelian (PO)</span></a>
                                        </li>
                                        <li class="nk-menu-item">
                                            <a href="{{ url('penerimaanbarang') }}" class="nk-menu-link"><span class="nk-menu-text">Penerimaan Barang (PB)</span></a>
                                        </li>
                                        <li class="nk-menu-item">
                                            <a href="{{ url('fakturpembelian') }}" class="nk-menu-link"><span class="nk-menu-text">Faktur Pembelian (FB)</span></a>
                                        </li>
                                        </li>
                                    </ul><!-- .nk-menu-sub -->
                                </li><!-- .nk-menu-item -->
